    ...
    <div className="mx-auto flex max-w-5xl flex-col gap-6 px-6 py-8">
      ...
      {activeTab === 'overview' && (
        <div className="flex flex-col gap-6">
          ...
          {/* Metadata */}
          {agent.metadata && (() => {
            // Fields already displayed elsewhere; exclude from "extra" section
            ...
            return (
              <div className="rounded-xl border border-[rgba(255,255,255,0.06)] bg-[rgba(255,255,255,0.02)] p-5">
                <p className="mb-4 text-[10px] font-semibold uppercase tracking-widest text-[#475569]">Metadata</p>
                ...
                <div className="flex flex-col gap-5">
                  ...
                  {(agent.metadata.services ?? []).length > 0 && (
                    <div>
                      <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-[#334155]">Services</p>
                      <div className="flex flex-col gap-2">
                        {agent.metadata.services!.map((svc, i) => (
                          <div
                            key={i}
                            className="rounded-lg border border-[rgba(255,255,255,0.05)] bg-[rgba(255,255,255,0.02)] px-4 py-3"
                          >
                  ...
                  {(agent.metadata.supportedTrust ?? []).length > 0 && (
                    <div>
                      <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-[#334155]">Supported Trust</p>
                      <div className="flex flex-wrap gap-1.5">
                        {agent.metadata.supportedTrust!.map((t) => (
                          <span
                            key={t}
                            className="rounded border border-[rgba(255,255,255,0.08)] bg-[rgba(255,255,255,0.04)] px-2 py-0.5 text-[11px] text-[#94A3B8]"
                          >
                            {t}
                          </span>
                        ))}
                  ...
                  {(agent.metadata.registrations ?? []).length > 0 && (
                    <div>
                      <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-[#334155]">Registrations</p>
                      <div className="divide-y divide-[rgba(255,255,255,0.04)]">
                        {agent.metadata.registrations!.map((reg, i) => (
                          <div key={i} className="flex items-center justify-between py-2">
                            <span className="font-data text-xs text-[#94A3B8]">#{reg.agentId}</span>
                            <span className="font-data text-[11px] text-[#475569]">
                              {truncateAddress(reg.agentRegistry)}
                            </span>
                          </div>
                        ))}
                      </div>
                  ...
                  {extraEntries.length > 0 && (
                    <div>
                      <p className="mb-2 text-[10px] font-semibold uppercase tracking-widest text-[#334155]">Additional Fields</p>
                      <div className="divide-y divide-[rgba(255,255,255,0.04)]">
